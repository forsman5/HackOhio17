...
public class MainActivity extends AppCompatActivity implements BLEManager {
...
//        mLogger.setMovementMethod(new ScrollingMovementMethod());
        mSendData = (Button) findViewById(R.id.takePhotoButton);
        mSendData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mPeripheral.writeCharacteristic(CHARACTERISTIC_ID, "takePhoto");
                mInput.setText("");
            }
        });
